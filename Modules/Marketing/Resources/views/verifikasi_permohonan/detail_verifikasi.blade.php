    ...
    <div class="dt-content">
        <div class="row">
            <div class="col-xl-12">
                ...
                @if(authorized("{$module}@edit") && in_array($dataPermohon->mohon_approved_status, ['on-progress', 'fix']))
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pb-1">
                                    <ul class="card-header-links nav nav-underline" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#pane1" role="tab"
                                               aria-controls="pane1" aria-selected="true">Overview</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#pane2" role="tab"
                                               aria-controls="pane3" aria-selected="true">Dokumen Pengajuan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#pane3" role="tab"
                                               aria-controls="pane4" aria-selected="true">Riwayat Pengajuan</a>
                                        </li>
                                    </ul>
                                    <!-- Tab Content-->
                                                ...
                                                <table class="table table-hover mb-0">
                                                        ...
                                                        <td colspan="4">
                                                            <div class="table-responsive col-xl-12 col-md-12 col-12">
                                                                <table class="table table-bordered  mb-0">
                                                                    <thead>
                                                                    <tr>
                                                                        <th class="text-uppercase" scope="col">Jenis
                                                                        </th>
                                                                    ...
                                                                    @foreach($dataPermohonSertifikasi as $dpser)
                                                                        <tr>
                                                                            <td>@if($dpser->mohon_det_jenis_status == 'baru')
                                                                                    Baru
                                                                                @else
                                                                                    Perpanjang
                                                                                @endif</td>
                                                            ...
                                                            <div class="table-responsive col-xl-12 col-md-12 col-12">
                                                                <table class="table table-bordered  mb-0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-uppercase" scope="col">Ukuran
                                                                        </th>
                                                                        <th class="text-uppercase" scope="col">Kapasitas
                                                                            Produksi/tahun
                                                                        </th>
                                                                    </tr>
                                                                    </thead>
                                                                    ...
                                                                    @foreach($dataPermohonKomoditi as $dpk)
                                                                        <tr>
                                                                            ...
                                                                            <td>@if($dpk->sert_is_product == 'ya')
                                                                                    {{$dpk->mohon_kmditi_sni}}
                                                                                @else
                                                                                    {{$dpk->sert_sni}}
                                                                                @endif</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_nama}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">4</th>
                                                        ...
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_nomor_akta_pendirian}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">5</th>
                                                        ...
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_nama_pemilik}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">6</th>
                                                        ...
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_nama_pimpinan}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">7</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_shif_kerja}}
                                                                Shift</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td>- Jumlah Manajemen</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_jumlah_manajemen}}
                                                                Orang</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td>- Jumlah Administrasi</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_jumlah_administrasi}}
                                                                Orang</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"></th>
                                                    ...
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td>- Jumlah Part-time</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_jumlah_part_time}}
                                                                Orang</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td>- Jumlah Operasional</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_jumlah_operasional}}
                                                                Orang</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;Jumlah Shift 1</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_jumlah_shift_1}}
                                                                Orang</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;Jumlah Shift 2</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_jumlah_shift_2}}
                                                                Orang</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;Jumlah Shift 3</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_jumlah_shift_3}}
                                                                Orang</a></td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row"></th>
                                                        <td>- Non permanen di bawah kendali langsung perusahaan</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_jumlah_non_permanen}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">9</th>
                                                        <td>Status perusahaan/klien</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->jenis_perusahaan_nama}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">10</th>
                                                        ...
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_luas_bangunan}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">11</th>
                                                        ...
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)"
                                                               class="btn-link">{{$dataPermohon->mohon_cust_luas_tanah}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="4">
                                                                ...
                                                                <div class="table-responsive col-xl-12 col-md-12 col-12">
                                                                    <table class="table mb-0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>:</td>
                                                                            <td>{{$dpp->mohon_pabrik_nama}} {{$dpp->mohon_pabrik_alamat}}
                                                                                , {{$dpp->kec_nama}}, {{$dpp->kab_nama}}
                                                                                , {{$dpp->prov_nama}} ;
                                                                                <hr/>
                                                                                Kode Pos
                                                                                : {{$dpp->mohon_pabrik_kode_pos}};
                                                                                <hr/>
                                                                                Fax : {{$dpp->mohon_pabrik_nomor_fax}};
                                                                                <hr/>
                                                                                Telp : {{$dpp->mohon_pabrik_nomor_telp}}
                                                                                ;
                                                                                <hr/>
                                                                                Hp : {{$dpp->mohon_pabrik_nomor_hp}}
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>:</td>
                                                                            <td>{{$dpp->mohon_pabrik_jumlah_karyawan}}
                                                                                Orang
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                    ...
                                                    <tr>
                                                        <th scope="row">12</th>
                                                        <td>Formulir Kelengkapan Permohonan</td>
                                                        <td>:</td>
                                                        <td><a href="javascript:void(0)" class="btn-link"><a
                                                                        href="{{url($dataPermohon->mohon_pertanyaan_filepath)}}"
                                                                        target="_blank" class="btn btn-xs btn-primary">Download</a></a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                            ...
                                                            <div class="card-footer d-flex flex-column justify-content-between p-0 text-sm-right">
                                                                ...
                                                                <a href="javascript:void(0)" class="display-5  mb-6">
                                                                    <i class="icon icon-calendar icon-fw mr-2"></i><span
                                                                            class="align-middle"
                                                                            style="font-size:12px;">{{$dps->created_at?->format("Y-m-d H:i:s")}}</span>
                                                                </a>
                                                                <!-- /pricing -->
                                                            </div>
                                                            <!-- /card footer -->
                                            ...
                                            <div class="media mb-5">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <a href="javascript:void(0)">{{$dataPermohon->mohon_cust_alamat}}
                                                        ...
                                                        @else
                                                            , {{$dataPermohon->kec_nama}}, {{$dataPermohon->kab_nama}}
                                                            , {{$dataPermohon->prov_nama}}
                                                        @endif</a>
                                                </div>
                                                <!-- /media body -->
                                            </div>
