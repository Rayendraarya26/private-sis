                ...
                <div class="dt-card">
                    <div class="dt-card__header">
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Data Master Komoditi</h3>
                        </div>
                    </div>
        ...
        $(function () {
                ...
                frozenColumns: [[
                    {field: 'ck', checkbox: true, sortable: false},
                    {
                        ...
                        formatter: function (val, row) {
                            let btnEdit = `<a href="{{url("$url/edit")}}/${row.komodt_id}" class="btn btn-primary btn-xs btn-block">Edit</a>`;
							let output = "";
            ...
            dg.datagrid(
                'enableFilter', [
                    ...
                    {field: 'komodt_nama', type: 'textbox'},
                ]);
        });
                ...
                if (result.value) {
					...
					for (var i = 0; i < data.rows.length; i++) {
						...
						if(atLeastOneIsChecked == true){
							idData.push(data.rows[i].komodt_id);
						}
					}
                    $.ajax({
                        url: `{{url("$url/delete")}}`,
