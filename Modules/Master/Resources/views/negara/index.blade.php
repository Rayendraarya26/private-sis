                ...
                <div class="dt-card">
                    <div class="dt-card__header">
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Data master Negara</h3>
                        </div>
                    </div>
    ...
    <script>
        $(function () {
            let dg = $('#ttData').datagrid({
                ...
                frozenColumns: [[
                    {field: 'ck', checkbox: true, sortable: false},
                    {
                        ...
                        formatter: function (val, row) {
                            let btnEdit = `<a href="{{url("$url/edit")}}/${row.negara_id}" class="btn btn-primary btn-xs btn-block">Edit</a>`;
                            let output = "";
                ...
                columns: [[
                    // {field: 'negara_kode', title: 'Kode Negara', width: 220, sortable: true},
                    {field: 'negara_nama', title: 'Negara', width: 300, sortable: true},
                ]],
            });
            dg.datagrid(
                'enableFilter', [
