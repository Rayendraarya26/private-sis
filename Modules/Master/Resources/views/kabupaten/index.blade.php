                ...
                <div class="dt-card">
                    <div class="dt-card__header">
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Data master Kabupaten</h3>
                        </div>
                    </div>
                ...
                frozenColumns: [[
                    {field: 'ck', checkbox: true, sortable: false},
                    {
                        ...
                        formatter: function (val, row) {
                            let btnEdit = `<a href="{{url("$url/edit")}}/${row.kab_id}" class="btn btn-primary btn-xs btn-block">Edit</a>`;
                ...
                if (result.value) {
					...
					for (var i = 0; i < data.rows.length; i++) {
						...
						if(atLeastOneIsChecked == true){
							idData.push(data.rows[i].kab_id);
						}
					}
                    $.ajax({
                        url: `{{url("$url/delete")}}`,
