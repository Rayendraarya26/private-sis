...
@section('title', 'Tambah Jenis Perusahaan')
                ...
                <div class="dt-card">
                    <div class="dt-card__header">
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Tambah Jenis Perusahaan</h3>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <form method="post" action="{{action("$module@store")}}">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-3" for="jenis_perusahaan_nama">Nama Jenis Perusahaan*</label>
                                        <div class="col-sm-8">
