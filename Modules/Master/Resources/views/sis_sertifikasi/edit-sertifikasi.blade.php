...
@section('title', 'Update Sertifikasi')
                ...
                <div class="dt-card">
                    <div class="dt-card__header">
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Update Sertifikasi</h3>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form method="post" action="{{action("$module@update")}}">
									...
									<input type="hidden" name="tipe" value="update-sertifikasi">
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="radio" name="sert_is_product" id="sert_is_product" value="ya" {{$data->sert_is_product == "ya" ? "checked" :""}} >
