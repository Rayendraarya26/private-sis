                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form method="post"
									...
									<div class="form-group row">
                                        <label class="col-form-label col-sm-3" for="bill_payment_status">
                                            Set Lunas
                                        </label>
                                        <div class="col-sm-8">
										
										<input type="checkbox" name="bill_payment_status" id="bill_payment_status" aria-label="Ya" value="ya" checked="checked"> Ya
											<br><small><span>Jika tidak di-centang maka billing otomatis lunas.</span></small>
                                        </div>
                                    </div>
