								...
								<div class="col-xl-9">
									...
									<!--
									 ...
									 -->
									  ...
									  <!-- Radio Button -->
									  <div class="custom-control custom-radio custom-control-inline">
										<input value="permohonan" aria-describedby="itms_bil_tipeHelp" type="radio" id="itms_bil_tipe2" name="itms_bil_tipe" class="custom-control-input" @click="setComboDataPermohonan()">
										<label class="custom-control-label" for="itms_bil_tipe2">Permohonan</label>
									  </div>
									  <!-- /radio button -->
            ...
            window.vueStepTwo = new Vue({
                ...
                methods: {
                    ...
                    validate() {
                        ...
                        if (this.bill_items.length === 0) throw "Mohon pilih data permohonan atau surveilans!"
                    },
                    ...
                    async resetFormItem() {
						...
						$("#myForm input:radio[name=itms_bil_tipe]").removeAttr("checked");
						$('#myForm input:radio[name=itms_bil_tipe]').each(function(){
