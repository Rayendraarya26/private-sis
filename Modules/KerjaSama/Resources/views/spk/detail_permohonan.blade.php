...
@section('title', 'Detail Permohonan dan Upload SPK')
    ...
    <div class="dt-content">
        <div class="row">
            <div class="col-xl-12">
                ...
                <a class="btn btn-sm btn-info" href="{{url("$url/edit?status=upload-spk&mohon_id=$dataPermohon->mohon_id")}}" style="margin-bottom: 20px"> <i class="fad fa-upload"></i> Upload SPK</a>
				@endif
			</div>
		</div>
		<hr/>
						...
						<div class="table-responsive">
						  <table class="table table-hover mb-0">
							<thead>
								...
								<tr>
								  ...
								  <th class="text-uppercase" scope="col">:</th>
								  <th class="text-uppercase" scope="col">@if($dataPermohon->mohon_spk_file != '') <a href="{{url($dataPermohon->mohon_spk_file)}}" target="_blank" class="btn btn-xs btn-primary">Download File</a> @endif</th>
								</tr>
							</thead>
						  </table>
						  ...
						  <table class="table table-hover mb-0">
							...
							<tbody>
								...
								<tr><th scope="row"></th><td></td><td></td><td><a href="{{url($dataPermohon->mohon_pertanyaan_filepath)}}" target="_blank" class="btn btn-xs btn-primary">Download Informasi Tambahan</a></td></tr>
							</tbody>
						  </table>
						</div>
                      </div>
