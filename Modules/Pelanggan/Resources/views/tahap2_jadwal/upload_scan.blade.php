                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <label for="berkas_ket">Unggah <b>Scan LKS</b> yang sudah diberi TTD dan cap
                                            @if(!empty($data->jadw_file_lks))
                                                &nbsp; | &nbsp;
                                                <a href="{{asset($data->jadw_file_lks)}}">
                                                    <i class="fad fa-download"></i> Download LKS
                                                </a>
                                            @endif
                                        </label>
                                        <input type="file" class="form-control" name="file_lks"
                                               accept="application/pdf">
                                    </div>
                                    <div class="form-group">
                                        <label for="berkas_ket">
                                            Unggah <b>Scan Laporan Ringkas</b> yang sudah diberi TTD dan cap
                                            @if(!empty($data->jadw_file_laporan_ringkas))
                                                &nbsp; | &nbsp;
                                                <a href="{{asset($data->jadw_file_laporan_ringkas)}}">
                                                    <i class="fad fa-download"></i> Download Laporan Ringkas
                                                </a>
                                            @endif
                                        </label>
                                        <input type="file" class="form-control" name="file_lap_ringkas"
                                               accept="application/pdf">
                                    </div>
                                    <div class="form-group">
                                        <label for="berkas_ket">
                                            Unggah <b>Scan Surat Tugas</b> yang sudah diberi TTD dan cap
                                            @if(!empty($data->jadw_file_surat_tugas))
                                                &nbsp; | &nbsp;
                                                <a href="{{asset($data->jadw_file_surat_tugas)}}">
                                    ...
                                    <div class="form-group">
                                        <label for="berkas_ket">
                                            ...
                                            @if(!empty($data->jadw_file_notulen))
                                                &nbsp; | &nbsp;
                                                <a href="{{asset($data->jadw_file_notulen)}}">
                                    ...
                                    <div class="form-group">
                                        <label for="berkas_ket">
                                            ...
                                            @if(!empty($data->jadw_file_subkon))
                                                &nbsp; | &nbsp;
                                                <a href="{{asset($data->jadw_file_subkon)}}">
