                ...
                methods: {
                    ...
                    async addKomoditas(pengajuanIndex) {
                        try {
                            ...
                            this.data_sertifikat[pengajuanIndex].komoditas.push(newKomoditas);
                    ...
                    async deleteKomoditi(pengajuanIndex, id) {
                        ...
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
                                this.data_sertifikat[pengajuanIndex].komoditas.splice(selectedKomoditasIdx, 1)
                            }
                        });
                    },
                    async editKomoditi(pengajuanIndex, id) {
                        let selectedKomoditas = this.data_sertifikat[pengajuanIndex].komoditas.find(e => e.id == id);
                    ...
                    setComboDataSertifikasi(pengajuanIndex) {
                        ...
                        $('#step2_jenis_sertifikasi' + pengajuanIndex).combogrid({
                            ...
                            onSelect: async function (index, row) {
                                await self.comboDataSertifikasiOnSelect(pengajuanIndex, row)
                            },
                        });
