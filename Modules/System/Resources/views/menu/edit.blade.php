                ...
                <div class="dt-card">
                    <div class="dt-card__header">
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Ubah Menu</h3>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control easyui-combotreegrid"
                                                   ...
                                                   value="{{old('menu_parent_id') ?? $data->menu_parent_id}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <textarea class="form-control" placeholder="Masukkan deskripsi..."
                                          name="menu_desc"
                                          id="menu_desc">{{old('menu_desc') ?? $data->menu_desc}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                   value="{{old('menu_order') ?? $data->menu_order}}"
...
@push('javascript')
    <script>
        @if(!empty($data->menu_is_active))
        $("#menu_is_active").val("{{$data->menu_is_active}}")
        @endif
