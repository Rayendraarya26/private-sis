...
@section('title', 'Edit Kompetensi PPC')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div style="text-align: center">
                                    <h4>Set Kompetensi PPC untuk <b>{{$pegawai->peg_nama}}</b></h4>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <input class="easyui-switchbutton" style="width: 100px"
                                                   data-options="onText:'Ya',offText:'Tidak',onChange: function(checked){submitKompetensi({{$komoditi->komodt_id}},checked);}"
                                                   id="{{'sert_'.$komoditi->komodt_id}}"
                                                {{in_array($komoditi->komodt_id, $selectedKomoditiId) ? 'checked' : ''}}>
                                        </td>
                                        <td>{{$komoditi->komodt_nama}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
