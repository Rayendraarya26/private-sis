							...
							<div class="form-group form-row">
								...
								<div class="col-md-10 col-sm-9">
								  ...
								  <div class="form-check form-check-inline">
									...
									<small class="form-text">Note: Jika "tidak" maka akan muncul pada menu penyusunan komite dan dilanjutkan untuk proses penilaian komite, jika "ya" maka sebaliknya, dan masih bisa diedit.</small>
								</div>
							</div>
