                ...
                <div class="col-xl-12">
                    <div class="dt-card">
                        <div class="dt-card__header">
                            <div class="dt-card__heading"><h3 class="dt-card__title">Informasi Data Jadwal No.
                                    #{{$dataJadwal->jadw_id}}</h3></div>
                        </div>
                                    ...
                                    <div class="card-header" id="headingOne">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link" type="button" data-toggle="collapse"
                                                    data-target="#collapse-one" aria-expanded="true"
                                                    aria-controls="collapse-one">1. Diajukan untuk
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="collapse-one" class="collapse hide" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-header" id="headingTwo">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse-two">2. Kronologis kegiatan *)
                                            </button>
                                        </h5>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <table class="table mb-0">
                                                ...
                                                <tr>
                                                    <td>
                                                        - Audit dilaksanakan
                                                        pada {{$dataJadwal->jadw_tanggal_mulai?->format("d M Y")}}
                                                        s/d {{$dataJadwal->jadw_tanggal_selesai?->format("d M Y")}}
                                                        <br/>
                                                        -
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <ul>
                                                            @foreach($dataMohon as $dp)
                                                                <li>Surat pemohon No {{$dp->mohon_id}}
                                                                    tanggal {{ $dp->created_at?->format("d M Y") }}</li>
                                                            @endforeach
                                                        </ul>
                                                            ...
                                                            <div class="col-xl-12">
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        ...
                                                                        <br/>
                                                                        Jumlah Temuan
                                                                        : {{$thp1->total_temuan * $thp1->total_det/ $thp1->total_data}}
                                                                    </div>
                                                                    <div class="col-md-4">
                                                        ...
                                                        <td>
                                                            <div class="col-xl-12">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        Tanggal {{ date('d M Y', strtotime($aud->jadw_tanggal_mulai)) }}
                                                                        s/d {{ date('d M Y', strtotime($aud->jadw_tanggal_selesai)) }}
                                                                    </div>
                                                                    <div class="col-md-12">
                                    ...
                                    <div class="card-header" id="heading4">
                                        <h5 class="mb-0">
                                            <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                                    ...
                                                    aria-controls="collapse-two">4. Data File
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="collapse-four" class="collapse" aria-labelledby="heading4"
                                         data-parent="#accordion-example">
                                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-row">
                                            <label class="col-md-2 col-sm-3 text-sm-right mb-4 mb-sm-0">Isi
                                                Rekomendasi</label>
                                        ...
                                        <div class="form-group form-row">
                                            <label class="col-md-2 col-sm-3 text-sm-right mb-4 mb-sm-0">Simpan Draft
                                                ?</label>
                                            <div class="col-md-10 col-sm-9">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                           name="rekmd_komte_status"
                                                           id="aud_thp1_status1" value="ditutup"
                                                           @click="setTutup('ditutup')">
                                                    <label class="form-check-label" for="aud_thp1_status1">Tidak</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio"
                                                           name="rekmd_komte_status"
                                                           id="aud_thp1_status2" value="on-going"
                                                           @click="setTutup('on-going')">
                                                    <label class="form-check-label" for="aud_thp1_status2">Ya</label>
                                                </div>
                                                <small class="form-text">Note: Jika "tidak" maka akan muncul pada menu
                                                    penyusunan komite dan dilanjutkan untuk proses penilaian komite,
                                                    jika "ya"
                                                    maka sebaliknya, dan masih bisa diedit.</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <!-- Dropzone -->
                                        <label for="upload-zone">Berkas Tambahan</label>
                                        <div id="upload-zone" class="dropzone"></div>
                                        <!-- /dropzone -->
                                    </div>
                                    <div class="col-md-2">
                                        <ol>
                                            <li v-for="df in dropzone_files">
                                                <a :href="df.file_url" target="_blank" :title="df.file_size + 'byte'">
                                                    @{{ df.file_name }}
                                                </a>
                                                &nbsp;&nbsp;&nbsp;
                                                <span style="cursor: pointer; color: red"
                                                      @click="deleteFileDropzone(df.file_id)">
                                                    <br>
    ...
    <script>
        ...
        $(document).ready(function () {
            window.vueRekomendasi = new Vue({
                ...
                mounted: function () {
                    this.$nextTick(() => {
                        ...
                        $('textarea#rekmd_komte_isi').tinymce({
                            ...
                            relative_urls: false,
                            placeholder: 'Tuliskan rekomendasi persetujuan...',
                            ...
                            }, {name: 'link', items: ['link', 'image']}, {name: 'restore', items: ['restoredraft']},
                            ],
                        });
                    })
                },
                methods: {
                    getFileDropzone() {
                        $.get(`{!! url("$url/ajax?action=dropzone-getfile&jadw_id=$dataJadwal->jadw_id") !!}`)
                            .then(response => {
                                this.dropzone_files = response.results
                            })
                    },
                    deleteFileDropzone(file_id) {
                        if (confirm("Anda yakin untuk menghapus file ini ?")) {
                            $.post(`{!! url("$url/ajax?action=dropzone-deletefile&jadw_id=$dataJadwal->jadw_id") !!}`, {file_id})
                                .then(response => {
                                    toastCenter({
                                        type: 'success',
                    ...
                    initDropzone() {
                        ...
                        $("#upload-zone").dropzone({
                            ...
                            url: `{!! url("$url/ajax?action=dropzone-uploadfile&jadw_id=$dataJadwal->jadw_id") !!}`,
                            acceptedFiles: 'application/pdf,image/jpg,image/jpeg,image/png',
                            init: function () {
                                this.on("complete", function (file) {
                                    this.removeFile(file)
                                    self.getFileDropzone();
                                });
                            }
                        });
                    },
                                ...
                                if (result.value) {
                                    ...
                                    $.ajax({
                                        ...
                                        error: function (xhr) {
                                            ...
                                            if (xhr.readyState === 0) toastCenter({
                                                type: 'error',
                                                title: "Network Error"
                                            })
