    ...
    <div class="dt-content">
        <div class="row">
            <div class="col-xl-12">
                ...
                <a class="btn btn-sm btn-info" href="{{url("$url/edit?status=persetujuan&mohon_id=$dataPermohon->mohon_id")}}" style="margin-bottom: 20px"> <i class="icon icon-upload"></i> Upload pernyataan persetujuan ?</a>
			</div>
		</div>
		<hr/>
        <div class="row">
