...
@section('title', 'Tambah Penjadwalan Tahap 1')
                        ...
                        <div id="smartwizard">
                            ...
                            <ul class="nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="#step-1">
                                        <strong>Langkah 1</strong> <br>Data Penjadwalan Tahap 1
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#step-2">
                                        <strong>Langkah 2</strong> <br>Daftar Tim
                                    </a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                                    @include("operatorls::penjadwalan_tahap1._create_step_1")
                                </div>
                                <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
                                    @include("operatorls::penjadwalan_tahap1._create_step_2")
                                </div>
                            </div>
                        </div>
