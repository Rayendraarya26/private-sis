...
@section('title', 'Penjadwalan Pencabutan Sertifikasi')
                ...
                <div class="dt-card">
                    <div class="dt-card__header">
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Data Jadwal Pencabutan Sertifikasi</h3>
                        </div>
                    </div>
        ...
        $(function () {
            let dg = $('#ttData').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'sert_nama', title: 'Sertifikasi', width: 350, sortable: true},
