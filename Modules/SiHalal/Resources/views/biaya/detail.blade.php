        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                @if(authorized("{$module}@updateStatus"))
                    <a class="btn btn-sm btn-info" href="javascript:void(0)" style="margin-bottom: 20px"
                       onclick="confirmAjuan('{{$data_permohonan['id_reg']}}')"> <i class="far fa-comment-alt-edit"></i>
                        Update Status => Ajuan</a>
                @endif
            </div>
        </div>
        <hr/>
                                        ...
                                        <div class="dt-card__body">
                                            <div class="media mb-5">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <a href="javascript:void(0)">{{$data_permohonan['alamat_pu']}}
                                                        , {{$data_permohonan['kota_pu']}}
                                                        , {{$data_permohonan['prov_pu']}}
                                                        , {{$data_permohonan['negara_pu']}},
                                                        Kodepos {{$data_permohonan['kode_pos_pu']}}</a>
                                                </div>
                                                <!-- /media body -->
                                            </div>
                                            <div class="media mb-5">
                            ...
                            <div class="card">
                                <div class="card-body pb-1">
                                    <ul class="card-header-links nav nav-underline" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#paneBiaya" role="tab"
                                               aria-controls="paneBiaya" aria-selected="true">Biaya</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#paneOverview" role="tab"
                                               aria-controls="paneOverview" aria-selected="true">Overview</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#paneDokumen" role="tab"
                                               aria-controls="paneDokumen" aria-selected="true">Dokumen</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#paneProduk" role="tab"
                                               aria-controls="paneProduk" aria-selected="true">Produk</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#panePabrik" role="tab"
                                               aria-controls="panePabrik" aria-selected="true">Pabrik</a>
                                        </li>
                                    </ul>
                                    <br/>
                                    <br/>
                                                        ...
                                                        <div>
                                                            <button class="btn btn-outline-danger btn-xs"
                                                                    onclick="confirmDelete()"><i
                                                                        class="fas fa-trash"></i> Hapus Biaya
                                                            </button>
                                                        </div>
                                                    @endif
                                                </div>
                                                    ...
                                                    <table class="table table-hover mb-0">
                                                        ...
                                                        @foreach($data_permohonan['documents'] as $dpd)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{config("app.sihalal_folder_dokumen_url")}}{{$dpd['file_dok']}}"
                                                    ...
                                                    <table class="table table-hover mb-0">
                                                        ...
                                                        @foreach($data_permohonan['products'] as $dpp)
                                                            <tr>
                                                                ...
                                                                <td>@if($dpp['foto_produk'] != '')
                                                                        <a href="https://ptsp.halal.go.id/file/{{$dpd['foto_produk']}}"
                                                                           target="_blank"
                                            ...
                                            <div class="table-responsive col-xl-12 col-md-12 col-12">
                                                <table class="table table-hover mb-0">
                                                    ...
                                                    @foreach($data_permohonan['factories'] as $dppab)
                                                        <tr>
                                                            <td>{{$dppab['nama']}}</td>
                                                            <td>{{$dppab['alamat']}}, {{$dppab['kab_kota']}}
                                                                , {{$dppab['provinsi']}}, {{$dppab['negara']}}</td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['no_daftar']}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{date('d-m-Y h:i:s', strtotime($data_permohonan['tgl_daftar']))}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['jenis_usaha']}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['jenis_daftar']}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['skala_usaha']}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['nama_pj']}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['no_kontak_pj']}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['email_pj']}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['jenis_produk']}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['merek_dagang']}}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-uppercase" scope="col"><a
                                                                    href="javascript:void(0)"
                                                                    class="btn-link">{{$data_permohonan['area_pemasaran']}}</a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
