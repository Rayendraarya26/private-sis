    ...
    <div class="dt-content">
        <div class="row">
            <div class="col-xl-12">
                ...
                <a class="btn btn-sm btn-info" href="javascript:void(0)" style="margin-bottom: 20px" onclick="confirmBiaya('{{$data_permohonan['id_reg']}}')"> <i class="far fa-comment-alt-edit"></i> Update Status => Periksa</a>
				@endif
			</div>
		</div>
		<hr/>
