				  ...
				  <div class="ml-sm-auto">
					<ul class="dt-list dt-list-bordered dt-list-one-third">
					  <li class="dt-list__item text-center">
						<h4 class="font-weight-medium mb-4 text-white">Arsip</h4>
					...
					<div class="card">
						<div class="card-body pb-1">
							<ul class="card-header-links nav nav-underline" role="tablist">
								<li class="nav-item">
									<a aria-controls="paneTable"  class="nav-link @if($pane_active == 'biaya') active @endif" href="{{ url($url."/detail/".$data_permohonan['id_reg']) }}?pane_active=biaya" role="tab">List Biaya</a>
								</li>
								<li class="nav-item">
								...
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="#paneLaporan" role="tab" aria-controls="paneLaporan" aria-selected="true">Laporan</a>
								</li>
								<li class="nav-item">
							...
							<div class="tab-content mt-5">
								...
								@elseif($pane_active == 'biaya')
									@include("$view._detail_pane_biaya")
								@endif
								</div>
								<div id="paneLaporan" class="tab-pane">
										...
										<table class="table mb-0">
											<tbody>
												...
												<tr>
												  ...
												  <td class="text-uppercase" scope="col">:</td>
												  <td class="text-uppercase" scope="col"><a href="javascript:void(0)" class="btn-link">...</a></td>
												</tr>
												<tr>
												  <td class="text-uppercase" scope="col">Keterangan</td>
												  <td class="text-uppercase" scope="col">:</td>
												  <td class="text-uppercase" scope="col"><a href="javascript:void(0)" class="btn-link">@if($data_pelaporan != null) {{$data_pelaporan['keterangan']}} @endif</a></td>
												</tr>
											</tbody>
										</table>
									</div>
...
@push("javascript")
    <script>
		...
		@if($pane_active == 'biaya')
			@include("$view._detail_pane_biaya_javascript")
		@endif
