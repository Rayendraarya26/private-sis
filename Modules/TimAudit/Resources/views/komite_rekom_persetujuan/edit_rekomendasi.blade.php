					  ...
					  <div class="dt-card__body">
						<div id="vueRekomendasi">
							<div class="form-group form-row" id="data_permohonan">
								...
								<div class="col-xl-8">
									<textarea class="form-control" v-on:keyup="validateSertifikat" name="rekmd_komte_isi" id="rekmd_komte_isi"></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-12">
								  <div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="rekmd_komte_status" id="aud_thp1_status1" value="tutup" @click="setTutup('tutup')" @if(isset($dataAudit->rekmd_komte_status)) @if($dataAudit->rekmd_komte_status == 'tutup') checked @endif @endif>
									<label class="form-check-label" for="aud_thp1_status1">Tutup</label>
								  </div>
								  <div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="rekmd_komte_status" id="aud_thp1_status2" value="on-going" @click="setTutup('on-going')" @if(isset($dataAudit->rekmd_komte_status)) @if($dataAudit->rekmd_komte_status == 'on-going') checked @endif @endif>
	...
	const swalWithBootstrapButtons = swal.mixin({
        ...
        $(document).ready(function () {
            window.vueRekomendasi = new Vue({
                ...
                methods: {
					validateSertifikat() {
                        this.rekmd_komte_isi = $("#rekmd_komte_isi").val();
                    },
                    submitRekomendasi() {
