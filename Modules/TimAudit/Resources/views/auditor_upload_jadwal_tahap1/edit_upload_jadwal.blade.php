...
@section('title', 'Upload File jadwal Tahap 1')
				...
				<div class="col-xl-12">	
					<div class="dt-card">
						...
						<div class="dt-card__body">
							<div id="vueUpload">
								@if ($dataJadwal->aud_thp1_file_jadwal != '')
									...
									<div class="col-xl-8">
										<a href="{{url($dataJadwal->aud_thp1_file_jadwal)}}" class="btn btn-xs btn-info" target="_blank">Download File</a>
									</div>
								</div>
								@endif
								<div class="form-group form-row" id="data_permohonan">
									...
									<div class="col-xl-8">
									   ...
									   name="aud_thp1_file_jadwal" id="aud_thp1_file_jadwal">
                ...
                methods: {
                    ...
                    submitPermohonan() {
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
								if ($.trim($("#aud_thp1_file_jadwal").val()) === "") {
									toastCenter({
												type: 'success',
									...
									formData.append("aud_thp1_id", `{{$dataJadwal->jadw_id}}`);
									formData.append("tipe", `upload-jadwal`);
									const file = document.querySelector("#aud_thp1_file_jadwal").files[0];
									formData.append("aud_thp1_file_jadwal", file)
