                ...
                frozenColumns: [[
                    {
                        ...
                        formatter: function (val, row) {
							...
							if(row.status_upload == 're-upload'){
								btnEdit = `<a href="{{ url("$url/edit") }}?tipe=upload-daftar-periksa&jadw_id=${row.jadw_id}" class="btn btn-warning btn-xs btn-block"><i class="fas fa-cloud-upload"></i> Re-Upload</a>`;
							}
							else{
								btnEdit = `<a href="{{ url("$url/edit") }}?tipe=upload-daftar-periksa&jadw_id=${row.jadw_id}" class="btn btn-primary btn-xs btn-block"><i class="fas fa-cloud-upload"></i> Upload</a>`;
							}
