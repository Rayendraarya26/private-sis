					...
					<div class="dt-card">
						<div class="dt-card__header">
							<div class="dt-card__heading">
								<h3 class="dt-card__title">Upload Daftar Periksa Auditor</h3>
							</div>
						</div>
						<div class="dt-card__body">
							<div id="vueUpload">
								@if ($dataJadwal->dftr_periksa_file != '')
									<div class="form-group form-row" id="data_permohonan">
									<label class="col-xl-3 col-form-label text-sm-left" for="mohon_id" >File Daftar Periksa Eksisting</label>
									<div class="col-xl-8">
										<a href="{{url($dataJadwal->dftr_periksa_file)}}" class="btn btn-xs btn-info" target="_blank">Download File</a>
									</div>
								</div>
								@endif
								<div class="form-group form-row" id="data_permohonan">
									<label class="col-xl-3 col-form-label text-sm-left" for="mohon_id" >File Daftar Periksa Baru</label>
									<div class="col-xl-8">
										<input type="file" class="form-control" aria-label="File Daftar Periksa"
									   @change="validateUploadJadwal" accept="application/pdf"
									   name="dftr_periksa_file" id="dftr_periksa_file">
                ...
                methods: {
                    ...
                    submitPermohonan() {
                        swalWithBootstrapButtons({
                            ...
                            if (result.value) {
								if ($.trim($("#dftr_periksa_file").val()) === "") {
									toastCenter({
												type: 'success',
												title: "Silahkan Unggah File Daftar Periksa"
											})
								}
								else{
									// Submit Permohonan
									...
									formData.append("tipe", `upload-daftar-periksa`);
									const file = document.querySelector("#dftr_periksa_file").files[0];
									formData.append("dftr_periksa_file", file)
