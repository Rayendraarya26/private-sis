                    ...
                    <div class="dt-card__body">
                        <div class="col-md-12">
                            <form method="post"
                                ...
                                <input type="hidden" name="lks_id" value="{{$lks->lks_id}}">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="hidden" value="{{$lks->jadw_audit_id}}" name="jadw_audit_id">
                                        <select name="jadw_audit_id" class="form-control" id="jadw_audit_id" disabled>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" placeholder="Masukkaan klausul..."
                                                  ...
                                                  id="lks_klausul_ketidaksesuaian">{{old('lks_klausul_ketidaksesuaian') ?? $lks->lks_klausul_ketidaksesuaian}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" placeholder="Masukkaan uraian..."
                                                  ...
                                                  id="lks_uraian_ketidaksesuaian">{{old('lks_uraian_ketidaksesuaian') ?? $lks->lks_uraian_ketidaksesuaian}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="lks_expired_date_perbaikan"
                                               class="form-control" id="lks_expired_date_perbaikan"
                                               data-toggle="datetimepicker" data-target="#lks_expired_date_perbaikan"
                                               value="{{old('lks_expired_date_perbaikan') ?? $lks->lks_expired_date_perbaikan}}">
...
@push('javascript')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#jadw_audit_id").val('{{old("jadw_audit_id") ?? $lks->jadw_audit_id}}')
            $("#lks_kategori_ketidaksesuaian").val('{{old("lks_kategori_ketidaksesuaian") ?? $lks->lks_kategori_ketidaksesuaian}}')
        });
    </script>
@endpush
