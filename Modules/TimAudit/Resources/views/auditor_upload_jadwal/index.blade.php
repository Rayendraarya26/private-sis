...
@section('title', 'Upload Jadwal Audit')
                ...
                <div class="dt-card">
                    <div class="dt-card__header">
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Data Jadwal Audit dan File Jadwal</h3>
                        </div>
                    </div>
    ...
    <script>
        $(function () {
            let dg = $('#ttData').datagrid({
                ...
                columns: [[
                    {field: 'jadw_file_jadwal', title: 'File<br>jadwal', width: 100, sortable: true,
						formatter: function (val, row) {
                            let btnDownload = ``;		
							if(row.jadw_file_jadwal != ''){
								btnDownload += `${row.jadw_file_jadwal}`;
							}
